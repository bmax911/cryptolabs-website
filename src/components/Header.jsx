    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-light-bg/80 dark:bg-dark-surface/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800/50">
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/auth" className="text-light-text dark:text-dark-text hover:text-primary dark:hover:text-cyan-400 transition-colors">Login</Link>
      ...
      <div id="menu" className="hidden md:hidden bg-light-bg dark:bg-dark-surface">
        ...
        <Link to="/auth" className="block py-2 px-6 text-sm text-light-text dark:text-dark-text hover:bg-gray-200 dark:hover:bg-gray-800">Login</Link>

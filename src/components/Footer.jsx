        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              ...
              <a href="mailto:support@cryptolabs.ai" aria-label="Mail" className="text-gray-400 hover:text-white">
              ...
              <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-400 hover:text-white">
